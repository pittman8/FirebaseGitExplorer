...
class WriteGists extends Component {
    constructor(props) {
        super(props);
        this.state = {
            index: 0,
    ...
    setData = x => {
        ...
        let nextIndex = index;
        let first = this.state.gists.length - 1;
        if (x === 0) {
            if (index !== 0) {
...
export default withStyles(styles)(WriteGists);
